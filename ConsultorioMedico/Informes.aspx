<%@ Page Title="" Language="C#" MasterPageFile="~/Base.Master" AutoEventWireup="true" CodeBehind="Informes.aspx.cs" Inherits="ConsultorioMedico.Informes" Async="true" %>
        ...
        <div class="card-body p-3">
            ...
            <div class="row gx-4">
                ...
                <div class="col-2">
                    <div class="h-100">
                        <br />
                        <asp:Button runat="server" Width="100%" CssClass="btn btn-dark" Text="Descargar" ID="btnDownloadPdf" OnClick="btnDownloadPdf_Click" />
                    </div>
                </div>
            </div>
